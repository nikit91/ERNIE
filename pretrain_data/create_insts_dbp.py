...
def run_proc(idx, n, file_list):
    for i in range(len(file_list)):
        if i % n == idx:
            ...
            print(file_list[i])
            command = "python3 code/create_instances_dbp.py --input_file_prefix {} --output_file {} --vocab_file ernie_base/vocab.txt --dupe_factor 1 --max_seq_length 256 --max_predictions_per_seq 40"
