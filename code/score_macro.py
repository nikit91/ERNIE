...
def score(key, prediction, verbose=False):
    ...
    if verbose:
        ...
        for relation in sorted(relations):
            ...
            sum_rel_prec = sum_rel_prec + prec
            sum_rel_rec = sum_rel_rec + recall
            sum_rel_f1 = sum_rel_f1 + f1
            # (print the score)
            ...
            sys.stdout.write("\n")
        print("")
    prec_macro = sum_rel_prec / float(len(relations))
    recall_macro = sum_rel_rec / float(len(relations))
